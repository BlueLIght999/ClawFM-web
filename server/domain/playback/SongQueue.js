/**
 * SongQueue — pure domain queue for playback history/current/future.
 *
 * No infrastructure dependencies. Persistence is handled by the
 * application service / composition root via toState/loadFromState.
 */
